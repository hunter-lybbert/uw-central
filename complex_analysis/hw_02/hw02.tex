...
$$ \sin x \cos x = 0 $$
$$ \sinh y \cosh y = 0. $$
Looking first at $ \sin x \cos x = 0 $ we know this is 0 if $\sin x = 0$ or $\cos x = 0$ therefore $x \in \{0, \frac{\pi}{2}, \pi, \frac{3\pi}{2}\}.$
...
\end{eqnarray*}
Now we don't want $\cos^2x = 0$ in our denominator so now $x \in \{0, \pi\}$ or other multiples of $\pi$.
\qed
\\
