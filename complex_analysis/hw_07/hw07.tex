...
\textit{Solution:} \\
Let's start with the case where $a \neq 0$, then
\begin{align*}
H(z) = \prod_{n=0}^\infty B(a_n,z)
	&= \prod_{n=0}^\infty \frac{|a_n|}{a_n} \frac{ a_n - z}{ 1 - \overline a_n z} \\
	&= \prod_{n=0}^\infty \left( 1 + \frac{|a_n| (a_n - z)}{a_n( 1 - \bar a_n z)} - 1 \right) \\
	&= \prod_{n=0}^\infty \left( 1 + \frac{|a_n| (a_n - z) - a_n( 1 - \bar a_n z)}{a_n( 1 - \bar a_n z)} \right) \\
	&= \prod_{n=0}^\infty \left( 1 + \frac{|a_n| a_n - |a_n|z - a_n  + a_n \bar a_n z}{a_n( 1 - \bar a_n z)} \right) \\
	&= \prod_{n=0}^\infty \left( 1 + \frac{|a_n| a_n - |a_n|z - a_n + |a_n|^2 z}{a_n( 1 - \bar a_n z)} \right)
\end{align*}
Letting $b_n(z) = \frac{|a_n| a_n - |a_n|z - a_n + |a_n|^2 z}{a_n( 1 - \bar a_n z)}$ we have
...
\begin{itemize}
\item $|\log \big(1 + b_n(z)\big)| \leq M_n$, or
\item $|b_n(z)| \leq M_n$
\end{itemize}
where $\sum_{n = 1}^\infty M_n < \infty$ and $M_n$ are constants.
Then the product
$$P (z) = \prod_{n=1}^\infty (1 + b_n(z))$$
