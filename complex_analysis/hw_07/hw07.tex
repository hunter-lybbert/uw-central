...
\left|\frac{ (1 - r_n)\E^{\I \theta_n} - z}{ \E^{\I \theta_n} - (1 - r_n) z} - 1 \right| 
	...
	&\leq \left|\frac{ - r_n\E^{\I \theta_n}}{ \E^{\I \theta_n} - (1 - r_n) z} \right| + \left| \frac{r_n z}{\E^{\I \theta_n} - (1 - r_n) z} \right| \\
	&\leq \frac{ r_n}{ \left|\E^{\I \theta_n} - (1 - r_n) z \right|} + \frac{r_n |z|}{ \left|\E^{\I \theta_n} - (1 - r_n) z\right|} \\
\end{align*}
\textbf{TODO: This is where we need maybe use the reverse triangle inequality on the denominator.} \\
