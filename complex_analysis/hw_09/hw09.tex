...
\end{align*}
Now to get to the final inequality requested we have
\begin{align*}
...
Now consider
$$
\rho^{2n} \geq \rho \implies
$$
$$
\rho^{-2n} \leq \rho^{-1} \implies
$$
$$
- \rho^{-2n} \geq - \rho^{-1} \implies
$$
$$
...
$$
Apply this to the term on the left then you get
$$
\frac 1 {1 - \rho^{-2n}} \frac {\rho^{1-n}} {(\rho - 1)^2}
