...
\noindent
Additionally, if we take the imaginary part of 
\begin{align*}
f(z) &= \frac 1 {2\pi} \int_0^{2\pi} f(\xi) \frac{1 - 2r \E^{\I (\theta - \phi)} + r^2}{1 - 2r \cos (\theta - \phi) + r^2} \D \theta \\
	...
	&= \frac 1 {2\pi} \int_0^{2\pi} u(\theta) \D \theta \\
	& \quad\quad - \frac 1 {2\pi} \int_0^{2\pi} u(\theta)\left(\frac{\I 2r\sin(\theta - \phi)}{1 - 2r \cos (\theta - \phi) + r^2} \right) \D \theta \\
	& \quad\quad + \frac 1 {2\pi} \int_0^{2\pi} \I v(\theta) \D \theta \\
	& \quad\quad - \frac 1 {2\pi} \int_0^{2\pi} \I v(\theta)\left(\frac{\I 2r\sin(\theta - \phi)}{1 - 2r \cos (\theta - \phi) + r^2} \right) \D \theta \\
	&= \frac 1 {2\pi} \int_0^{2\pi} u(\theta) \D \theta \\
	& \quad\quad - \I \frac 1 {2\pi} \int_0^{2\pi} u(\theta)\left(\frac{2r\sin(\theta - \phi)}{1 - 2r \cos (\theta - \phi) + r^2} \right) \D \theta \\
	& \quad\quad + \I \frac 1 {2\pi} \int_0^{2\pi} v(\theta) \D \theta \\
	& \quad\quad - \I^2 \frac 1 {2\pi} \int_0^{2\pi} v(\theta)\left(\frac{2r\sin(\theta - \phi)}{1 - 2r \cos (\theta - \phi) + r^2} \right) \D \theta \\
	&= \frac 1 {2\pi} \int_0^{2\pi} u(\theta) \D \theta \\
	& \quad\quad - \I \frac 1 {2\pi} \int_0^{2\pi} u(\theta)\left(\frac{2r\sin(\theta - \phi)}{1 - 2r \cos (\theta - \phi) + r^2} \right) \D \theta \\
	& \quad\quad + \I \frac 1 {2\pi} \int_0^{2\pi} v(\theta) \D \theta \\
	& \quad\quad + \frac 1 {2\pi} \int_0^{2\pi} v(\theta)\left(\frac{2r\sin(\theta - \phi)}{1 - 2r \cos (\theta - \phi) + r^2} \right) \D \theta \\
\end{align*}
Now the imaginary part of this is
\begin{align*}
\Im (f(z)) &= \frac 1 {2\pi} \int_0^{2\pi} v(\theta) \D \theta - \frac 1 {2\pi} \int_0^{2\pi} u(\theta)\frac{2r\sin(\theta - \phi)}{1 - 2r \cos (\theta - \phi) + r^2} \D \theta \\
