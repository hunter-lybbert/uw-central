...
&=& y^3 + \left(\frac{1}{3}a^2  - \frac{2a^2}{3} + b\right)y + \left(\frac{a^3}{27} + \frac{a^3}{9} - \frac{ba}{3}\right) + c
\end{eqnarray*}
thus $p$ and $q$ are defined as follows $$p = \frac{1}{3}a^2  - \frac{2a^2}{3} + b$$ $$q = \frac{a^3}{27} + \frac{a^3}{9} - \frac{ba}{3}.$$
