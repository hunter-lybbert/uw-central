...
\end{align*}
  \item Consider the function
   ...
   Now we can use the FTC and compute $F(b) - F(a)$. \textbf{TODO}. Also maybe do the limit as you approach 1.
   ...
   straight line. \\
   \textit{Solution:} \\
   Use a similar argument as from before, but this time for $\log(-\varphi(z))$.
 \end{itemize}
